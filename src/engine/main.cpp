...
#define VSCRIPT
#include "entity/vsupdate.h"
#include "entity/ga_entity.h"
#include "entity/ga_vscript_component.h"
...
int main(int argc, const char** argv)
{
	...
	// Create an entity whose movement is driven by a visual script.
	ga_entity vscript;
	vscript.translate({ 0.0f, 2.0f, 1.0f });
	ga_vscript_component vs_move(&vscript, vsupdate);
	ga_cube_component vs_model(&vscript, "data/textures/rpi.png");
	sim->add_entity(&vscript);
